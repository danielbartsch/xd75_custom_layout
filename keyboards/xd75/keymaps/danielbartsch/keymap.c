...
/* WORKMAN
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | ESC    | 0      | 1      | 2      | 3      | 4      | DEL    |        | DEL    | 5      | 6      | 7      | 8      | 9      | PRINT  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | CAPS   | q      | d      | r      | w      | b      | BACKSP |        | BACKSP | j      | f      | u      | p      | ;      |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------|
 * | TAB    | a      | s      | h      | t      | g      | ENTER  |        | ENTER  | y      | n      | e      | o      | i      |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------+--------|
...
[_WM] = { /* WORKMAN */
  { KC_ESC,  KC_0,   KC_1,   KC_2,    KC_3,            KC_4,     KC_DEL,  __ss__,  KC_DEL,    KC_5,    KC_6,            KC_7,    KC_8,   KC_9,    KC_PSCR },
  { KC_CAPS, KC_Q,   KC_D,   KC_R,    KC_W,            KC_B,     KC_BSPC, __ss__,  KC_BSPC,   KC_J,    KC_F,            KC_U,    KC_P,   KC_SCLN, __ss__ },
  { KC_TAB,  KC_A,   KC_S,   KC_H,    KC_T,            KC_G,     KC_ENT,  __ss__,  KC_ENT,    KC_Y,    KC_N,            KC_E,    KC_O,   KC_I,    __ss__ },
