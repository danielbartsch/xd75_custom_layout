 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { ______, ______, ______, ______,  ______,  KC_UNDS,______, ______, ______, S(KC_8), ______,  ______,  ______,  ______, ______ },
  { ______, ______, ______, KC_LCBR, KC_LBRC, KC_LPRN,______, ______, ______, KC_RPRN, KC_RBRC, KC_RCBR, KC_EQL,  ______, ______ },
  { ______, ______, ______, ______,  ______,  KC_PMNS,______, ______, ______, KC_PPLS, ______,  ______,  S(KC_1), ______, ______ },
