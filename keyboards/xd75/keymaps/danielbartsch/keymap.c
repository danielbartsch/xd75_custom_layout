...
[_WM] = { /* WORKMAN */
  { KC_ESC,  KC_0,              KC_1,            KC_2,    KC_3,  KC_4,     KC_5,    KC_6,  KC_7,    KC_8,    KC_9,    __ss__,       KC_DEL,   KC_PGUP,   KC_HOME },
  { DF(_SH), KC_Q,              KC_D,            KC_R,    KC_W,  KC_B,     KC_J,    KC_F,  KC_U,    KC_P,    KC_EQL,  KC_DLR, KC_BSPC,  KC_PGDOWN, KC_END },
  ...
  { __ss__,  KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, KC_LALT, LS_SH, KC_LCTRL, KC_RCTL, LS_FN, KC_RALT, KC_LOCK, __ss__,  KC_MENU,      KC_LEFT,  KC_DOWN,   KC_RGHT },
},
...
[_SH] = { /* SHIFT */
  ...
  { DF(_WM), ______, ______, ______, ______, ______, ______, ______, ______,  ______,  KC_PPLS, RSFT(KC_5), ______, ______, ______ },
