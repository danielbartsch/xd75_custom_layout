 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------|
 * |        | TAB    | a      | s      | h      | t      | g      | Enter  | y      | n      | e      | o      | i      |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------+--------|
 * |        |        | z      | x      | m      | c      | v      | UP     | k      | l      | ,      | .      | /      |        |        |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LGUI   |        |        |        | LCTRL  | SPACELS| LEFT   | DOWN   | RIGHT  | SPACEFN| RALT   |        |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
...
[_WM] = { /* WORKMAN */
  ...
  { KC_LGUI,__ss__,  __ss__, __ss__, KC_LCTRL, LT(_SH, __ss__), KC_LEFT,KC_DOWN, KC_RGHT, LT(_FN, __ss__), KC_RALT,  __ss__, __ss__,  __ss__, __ss__ },
 },
...
[_SH] = { /* SHIFT */
  { ______, ______, ______,     ______,     ______,     ______,     RSFT(KC_HOME), ______,        RSFT(KC_END),  ______,     ______,      ______,     ______,     ______, ______ },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, ______, KC_AT,   KC_UNDS, KC_AMPR,KC_CIRC,______,    KC_GRV, ______,  KC_ASTR, KC_EQL,  ______,  ______, ______ },
  { ______,            ______,          KC_LT,  KC_LCBR, KC_LBRC, KC_LPRN,KC_HASH,______,    KC_DQT, KC_RPRN, KC_RBRC, KC_RCBR, KC_GT,   ______, ______ },
  { ______,            ______,          ______, ______,  ______,  KC_PMNS,KC_DLR, KC_PGUP,   KC_QUOT,KC_PPLS, ______,  ______,  KC_PIPE, ______, ______ },
